...
feature_combos_names = { "set3":['CWDlength', 'phi', 'FractionGroundContact', 'IsModerate'],
...
data_new = [data[:, combo] for combo in feature_combos]
...
for nf in range (0,4):
        ...
        for data_subset in data_new:          # data_subset YA es la matriz del combo
        
            
            
            r=data_subset.shape[1]-1
            ...
            #final_row = [feature_combos] + col_avg2.tolist()
            #feature_name_list = feature_combos_names[f"set{3}"]
